...
open class CategoryRepositoryFirestore(
    ...
    override suspend fun fetchCategories(
        ...
        try {
            ...
            val cachedCategories = dao.getAllCategories()
    ...
    override suspend fun fetchCategoryBySubcategoryId(
        ...
        try {
            ...
            val cachedCategory = categories.find { category ->
            ...
            val category =
                fetchedCategories.find { category -> category.subcategories.any { it.name == subcategoryId } }
        ...
        return try {
            ...
            if (cachedCategory != null) {
                ...
                if (subcategories.isNotEmpty()) {
                    Log.d(
                        "fetchSubcategoriesSuspend",
                        "Returning cached subcategories for $categoryId"
                    )
