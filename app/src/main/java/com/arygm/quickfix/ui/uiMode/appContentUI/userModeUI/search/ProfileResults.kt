...
fun ProfileResults(
  ...
  LazyColumn(modifier = modifier.fillMaxWidth().testTag("worker_profiles_list"), state = listState) {
    items(profiles.size) { index ->
      ...
      if (account != null && profileImage != null) {
        SearchWorkerProfileResult(
            modifier = Modifier.fillMaxWidth().testTag("worker_profile_result_$index").clickable {},
