...
object WorkerTopLevelDestinations {
    val HOME = TopLevelDestination(route = WorkerRoute.HOME, icon = Icons.Filled.Home, textId = "Home")
    val ANNOUNCEMENT =
        TopLevelDestination(
            route = WorkerRoute.ANNOUNCEMENT, icon = Icons.Filled.AccountCircle, textId = "Announcement")
    val MESSAGES =
        TopLevelDestination(route = WorkerRoute.MESSAGES, icon = Icons.Filled.Search, textId = "Messages")
    val PROFILE =
