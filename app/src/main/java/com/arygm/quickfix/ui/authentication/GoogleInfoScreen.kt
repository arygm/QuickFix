...
@Composable
fun GoogleInfoScreen(navigationActions: NavigationActions, loggedInAccountViewModel: LoggedInAccountViewModel, accountViewModel: AccountViewModel, userViewModel: ProfileViewModel) {
                ...
                Box(
                    ...
                    Column(
                        ...
                        Button(
                            onClick = {
                                shrinkBox = false
                                accountViewModel.updateAccount(Account(loggedInAccount!!.uid,firstName,lastName,loggedInAccount!!.email,
                                    stringToTimestamp(birthDate)!!,loggedInAccount!!.isWorker),
                                    onSuccess = {
                                        loggedInAccountViewModel.setLoggedInAccount(Account(loggedInAccount!!.uid,firstName,lastName,loggedInAccount!!.email,
                                            stringToTimestamp(birthDate)!!,loggedInAccount!!.isWorker))
