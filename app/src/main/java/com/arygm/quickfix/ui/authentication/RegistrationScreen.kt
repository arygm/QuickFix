  ...
  Box(modifier = Modifier.fillMaxSize()) {
    ...
    Scaffold(
        ...
        content = { pd ->
          Box(
              modifier =
                  Modifier.fillMaxSize().background(backgroundColor).padding(pd).imePadding()) {
                Box(
                    modifier =
                      ...
                      Row(
                          ...
                          horizontalArrangement =
                            ...
                            OutlinedTextField(
                                ...
                                modifier =
                                    Modifier.weight(
                                            1f) // This ensures both fields take up equal space
                                        .padding(end = 8.dp),
                                textStyle =
                            ...
                            Checkbox(
                                ...
                                colors =
                                    CheckboxDefaults.colors(
                                        checkedColor =
                                            color1, // The color of the checkbox when checked
                                        uncheckedColor =
                                            Color(0xFFc0c0c0), // Lighter color when unchecked
