...
fun RegisterScreen(
    ...
    BoxWithConstraints (
        ...
        val boxOffsetX by
        animateDpAsState(
            targetValue = if (shrinkBox) BOX_OFFSET_X_SHRUNK * widthRatio else BOX_OFFSET_X_EXPANDED * widthRatio,
                ...
                Box(
                    ...
                    Box(
                        ...
                        Column(
                            ...
                            Column(
                                modifier = Modifier.fillMaxWidth().padding(start = 8.dp * widthRatio),
                            ) {
                                QuickFixTextFieldCustom(
                                    ...
                                    label = {
                                        Text(
                                            ...
                                            modifier =
                                            Modifier.padding(start = 3.dp * heightRatio).testTag("emailText"))
                                    })
                            }
                            ...
                            Row(
                                ...
                                PasswordConditions(password, passwordConditions1, widthRatio, heightRatio)
                                PasswordConditions(password, passwordConditions2, widthRatio, heightRatio)
                            }
...
@Composable
private fun PasswordConditions(password: String, listConditions: List<Pair<String, Boolean>>, widthRatio:Float = 1f, heightRatio: Float = 1f) {
