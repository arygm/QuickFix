...
class AnnouncementViewModelTest {
    ...
    fun setUp() {
        ...
        doAnswer { invocation ->
            ...
            onSuccess()
            null
        }.whenever(mockRepository).init(any())

        announcementViewModel = AnnouncementViewModel(mockRepository, mockPreferencesRepository, mockProfileRepository)
    ...
    fun `getAnnouncements success updates announcements`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockRepository).getAnnouncements(any(), any())
    ...
    @Test
    fun `getAnnouncementsForUser updates announcementsForUser on success and fetches images`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockRepository).getAnnouncementsForUser(eq(announcementIds), any(), any())
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockRepository).fetchAnnouncementsImagesAsBitmaps(anyString(), any(), any())
        ...
        verify(mockRepository, times(fetchedAnnouncements.size)).fetchAnnouncementsImagesAsBitmaps(anyString(), any(), any())
    }
    ...
    fun `getAnnouncementsForCurrentUser no announcements in profile`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockProfileRepository).getProfileById(eq("user1"), any(), any())
    ...
    fun `getAnnouncementsForCurrentUser fetches announcements on success`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockRepository).getAnnouncementsForUser(eq(listOf("announcement1")), any(), any())
    ...
    fun `announce success updates announcementsForUser and fetches images`() = runTest {
        doAnswer { invocation ->
            ...
            onSuccess()
            null
        }.whenever(mockRepository).announce(eq(announcement1), any(), any())
        ...
        doAnswer { invocation ->
            ...
            onSuccess(emptyList())
            null
        }.whenever(mockRepository).fetchAnnouncementsImagesAsBitmaps(eq("announcement1"), any(), any())
    ...
    fun `uploadAnnouncementImages success calls onSuccess`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            null
        }.whenever(mockRepository).uploadAnnouncementImages(eq("announcement1"), eq(images), any(), any())
    ...
    fun `updateAnnouncement success replaces old announcement and fetches images`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            onSuccess()
            null
        }.whenever(mockRepository).updateAnnouncement(eq(updatedAnnouncement1), any(), any())
    ...
    fun `updateAnnouncement failure logs error`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            onFailure(exception)
            null
        }.whenever(mockRepository).updateAnnouncement(eq(announcement1), any(), any())
    ...
    @Test
    fun `deleteAnnouncementById success updates announcementsForUser and removes from profile`() = runTest {
        ...
        doAnswer { invocation ->
            ...
            onSuccess()
            null
        }.whenever(mockProfileRepository).updateProfile(any(), any(), any())
        ...
        doAnswer { invocation ->
            ...
            onSuccess()
            null
        }.whenever(mockRepository).deleteAnnouncementById(eq("announcement1"), any(), any())
